...
PROJECT_NAME='CarComment'

SPIDER_MODULES = ['CarComment.spiders']
NEWSPIDER_MODULE = 'CarComment.spiders'


#MongoDB设置
MONGODB_IP='192.168.11.17'
MONGODB_DB='CrawlerData_other'
MONGODB_TABLE='CarComment'
...
DOWNLOADER_MIDDLEWARES = {
    # 用于轮换UA
    'CarComment.middlewares.UserAgentMiddleware': 400,
    # 用于轮换代理IP （一般无需使用）
...
ITEM_PIPELINES = {
    #'CarComment.pipelines.DefaultValuePipeline': 300,
    'CarComment.pipelines.PreprocessPipeline': 300,
    #'CarComment.pipelines.toCsvPipeline': 310,
    'CarComment.pipelines.toMongodbPipeline': 320,
}
