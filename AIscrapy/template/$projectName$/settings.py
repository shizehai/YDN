...
DOWNLOADER_MIDDLEWARES = {
    # 用于轮换UA
    '$projectName$.middlewares.UserAgentMiddleware': 400,
    # 用于轮换代理IP （一般无需使用）
...
ITEM_PIPELINES = {
    #'$projectName$.pipelines.DefaultValuePipeline': 300,
    '$projectName$.pipelines.PreprocessPipeline': 300,
    #'$projectName$.pipelines.toCsvPipeline': 310,
    '$projectName$.pipelines.toMongodbPipeline': 320,
}
