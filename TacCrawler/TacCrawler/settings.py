...
SPIDER_MODULES = ['TacCrawler.spiders']
NEWSPIDER_MODULE = 'TacCrawler.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    # 用于轮换UA
    'TacCrawler.middlewares.UserAgentMiddleware': 400,
    # 用于轮换代理IP （一般无需使用）
...
ITEM_PIPELINES = {
    #'guaziCarCrawler.pipelines.DefaultValuePipeline': 300,
    'TacCrawler.pipelines.PreprocessPipeline': 300,
    # 'tenaaCrawler.pipelines.toCsvPipeline': 310,
    'TacCrawler.pipelines.toMongodbPipeline': 320,
}
